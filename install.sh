...
echo "📥 Baixando Telegram SaaS do GitHub..."
if [ -f "telegram-saas-integrado.zip" ]; then
    echo "📁 Arquivo ZIP já existe, removendo versão antiga..."
    rm -f telegram-saas-integrado.zip
fi

wget -O telegram-saas-integrado.zip "https://github.com/Lucasfig199/TEL-SAAS-3.0/raw/main/telegram-saas-integrado.zip"
